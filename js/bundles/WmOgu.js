...
var WmOgu = function (_Component) {
  _inherits(WmOgu, _Component);

  function WmOgu() {
    _classCallCheck(this, WmOgu);

    return _possibleConstructorReturn(this, (WmOgu.__proto__ || Object.getPrototypeOf(WmOgu)).apply(this, arguments));
  }
...
_metalSoy2.default.register(WmOgu, _step_3Soy2.default);

exports.default = WmOgu;
...
exports.templates = exports.WmOgu = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace WmOgu.
   * @public
   */

  goog.module('WmOgu.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param462 = function param462() {
      ...
      ie_close('h2');
      ie_open('p');
      itext('Once you have set up a cache partition, you can use ');
      ie_open('code');
      itext('CacheStore');
      ie_close('code');
      itext(' to easily access your cache.');
      ie_close('p');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'WmOgu.render';
  }
...
_metalSoy2.default.register(WmOgu, templates);
exports.WmOgu = WmOgu;
