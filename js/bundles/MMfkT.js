...
var MMfkT = function (_Component) {
  _inherits(MMfkT, _Component);

  function MMfkT() {
    _classCallCheck(this, MMfkT);

    return _possibleConstructorReturn(this, (MMfkT.__proto__ || Object.getPrototypeOf(MMfkT)).apply(this, arguments));
  }
...
_metalSoy2.default.register(MMfkT, _step_6Soy2.default);

exports.default = MMfkT;
...
exports.templates = exports.MMfkT = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace MMfkT.
   * @public
   */

  goog.module('MMfkT.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'MMfkT.render';
  }
...
_metalSoy2.default.register(MMfkT, templates);
exports.MMfkT = MMfkT;
