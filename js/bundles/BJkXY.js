...
var BJkXY = function (_Component) {
  _inherits(BJkXY, _Component);

  function BJkXY() {
    _classCallCheck(this, BJkXY);

    return _possibleConstructorReturn(this, (BJkXY.__proto__ || Object.getPrototypeOf(BJkXY)).apply(this, arguments));
  }
...
_metalSoy2.default.register(BJkXY, _step_2Soy2.default);

exports.default = BJkXY;
...
exports.templates = exports.BJkXY = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace BJkXY.
   * @public
   */

  goog.module('BJkXY.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param441 = function param441() {
      ...
      ie_close('p');
      ie_open('p');
      itext('Config.apex uses Func objects from R.apex, and a Func is actually a custom Apex object that mimics the behavior of a function.');
      ie_close('p');
      ie_open('p');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'BJkXY.render';
  }
...
_metalSoy2.default.register(BJkXY, templates);
exports.BJkXY = BJkXY;
